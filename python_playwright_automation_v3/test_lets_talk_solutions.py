...
CSV_FILENAME = "lets_talk_solutions_data.csv" # Filled by outer format
...
def test_lets_talk_solutions_elements(module_page: Page, test_case: dict): # Use the module-scoped page
